...
export default function NotificationsPage({ onChange }) {
  ...
  function load() {
    api
      .notifications(token)
      .then((data) => {
        // Filter to only display unread notifications
    ...
    <div>
      <div className="page-header">
        ...
        <p className="page-lede">
          Alerts from the matching engine, claim updates, and admin decisions.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          Nothing here yet. You&apos;ll be notified the moment there&apos;s a match.
        </div>
      ) : (
